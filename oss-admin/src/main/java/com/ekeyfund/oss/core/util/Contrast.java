...
import com.ekeyfund.oss.core.common.constant.dictmap.factory.DictFieldWarpperFactory;
...
public class Contrast {
    ...
    public static String contrastObj(Class dictClass, String key, Object pojo1, Map<String, String> pojo2) throws IllegalAccessException, InstantiationException {
        ...
        String str = parseMutiKey(dictMap, key, BeanKit.beanToMap(pojo1),pojo2) + separator;
        try {
            if(null!=pojo1){
                Class clazz = pojo1.getClass();
                Field[] fields = pojo1.getClass().getDeclaredFields();
     ...
     */
    public static String parseMutiKey(AbstractDictMap dictMap, String key, Map<String, Object> pojo1,Map<String, String> requests) {
