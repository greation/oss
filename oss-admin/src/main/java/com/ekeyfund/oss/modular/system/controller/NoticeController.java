...
import com.ekeyfund.oss.core.common.constant.dictmap.NoticeMap;
...
import com.ekeyfund.oss.modular.system.model.Notice;
import com.ekeyfund.oss.modular.system.service.INoticeService;
import com.ekeyfund.oss.modular.system.warpper.NoticeWrapper;
...
public class NoticeController extends BaseController {
    ...
    @DataLog(value = "新增通知",model = Notice.class,dict = NoticeMap.class)
    ...
    public Object add(Notice notice) {
        ...
        notice.insert();
        //
        LogObjectHolder.me().set(notice.getId());
        return SUCCESS_TIP;
    }
    ...
    @DataLog(value = "删除通知",model = Notice.class,keyParam = "noticeId",dict = NoticeMap.class)
    ...
    @DataLog(value = "删除通知",model = Notice.class,keyParam = "id",dict = NoticeMap.class)
