...
import com.ekeyfund.oss.core.common.constant.dictmap.DictMap;
...
import com.ekeyfund.oss.modular.system.service.IDictService;
import com.ekeyfund.oss.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
    ...
    @DataLog(value = "添加字典记录",keyParam = "",model = Dict.class,dict = DictMap.class)
    ...
    @DataLog(value = "修改字典",keyParam = "dictId",model = Dict.class,dict = DictMap.class)
    ...
    @DataLog(value = "删除字典记录",keyParam = "dictId",model = Dict.class,dict = DictMap.class)
