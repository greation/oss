...
import com.ekeyfund.oss.modular.system.dao.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    public List<Map<String, Object>> selectMenus(String condition, String level) {
        return this.baseMapper.selectMenus(condition, level,null, null);
    }
    ...
    @Override
    public List<Map<String, Object>> selectMenusByPcode(String pcode) {
        return this.baseMapper.selectMenus(null, null, pcode, 0);
    }
}
