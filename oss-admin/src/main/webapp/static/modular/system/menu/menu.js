...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: 'id', field: 'id', visible: false, align: 'center', valign: 'middle',formatter:Menu.idFunction},
...
Menu.idFunction = function (value, row, index) {
    return [
        '<a href="javascript:void(0)" title='+ row.id +'><span  class="text_split"  style="width: 120px;">'+ row.id +'</span></a>'
    ].join("");
};
/**
 * 检查是否选中
