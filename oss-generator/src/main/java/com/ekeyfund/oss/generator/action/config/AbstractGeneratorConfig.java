...
import com.ekeyfund.oss.core.util.FileUtil;
import com.ekeyfund.oss.generator.action.po.GunsTableInfo;
import com.ekeyfund.oss.generator.engine.SimpleTemplateEngine;
import com.ekeyfund.oss.generator.engine.base.GunsTemplateEngine;
import com.ekeyfund.oss.generator.engine.config.ContextConfig;
import com.ekeyfund.oss.generator.engine.config.SqlConfig;
...
//        }
    ...
    public void doMpGeneration() {
        ...
        if (tableInfoList != null && tableInfoList.size() > 0) {
            this.tableInfo = new GunsTableInfo(tableInfoList.get(0),autoGenerator.getStrategy());
        }
    }
