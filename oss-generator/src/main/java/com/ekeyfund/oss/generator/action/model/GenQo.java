package com.ekeyfund.oss.generator.action.model;
...
public class GenQo {
     ...
     * 操作日志页面
     */
    private Boolean oplogPageSwitch = false;
     ...
     * 实体父类属性
     */
    private String [] superEntityColumns = {"id","version","roleId","delflag","createtime","creater","updatetime","updater"};
