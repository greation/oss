package com.ekeyfund.oss.generator.engine.base;
...
public abstract class GunsTemplateEngine extends AbstractTemplateEngine {
    ...
    public void start() {
        ...
        if (super.contextConfig.getOplogPageSwitch()) {
            generatePageOplogHtml();
        }
    ...
    protected abstract void generatePageOplogHtml();
