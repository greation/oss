...
public class ContextConfig {
    ...
    private String proPackage = "com.ekeyfund.oss.admin";
    private String coreBasePackage = "com.ekeyfund.oss.core";
    private String modelPackageName = "com.ekeyfund.oss.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.ekeyfund.oss.modular.system.dao";    //model的dao
    ...
    private Boolean oplogPageSwitch = true;     //操作日志页面
    ...
    private DatasourceEnum datasourceEnum;       //数据源，生成service的数据源

    public void init() {
        if (entityName == null) {
            entityName = bizEnBigName;
        }
        modelPackageName = proPackage + "." + "modular."+getModuleName()+".model";
        modelMapperPackageName = proPackage + "." + "modular."+getModuleName()+".dao";
    }
    ...
    public Boolean getOplogPageSwitch() {
        return oplogPageSwitch;
    }

    public void setOplogPageSwitch(Boolean oplogPageSwitch) {
        this.oplogPageSwitch = oplogPageSwitch;
    }
