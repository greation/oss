...
public class PageConfig {
    ...
    private String pageOplogPathTemplate;
    ...
    public void init() {
        ...
        pageOplogPathTemplate = "\\src\\main\\webapp\\WEB-INF\\view\\" + contextConfig.getModuleName() + "\\{}\\{}_oplog.html";
    ...
    public String getPageOplogPathTemplate() {
        return pageOplogPathTemplate;
    }

    public void setPageOplogPathTemplate(String pageOplogPathTemplate) {
        this.pageOplogPathTemplate = pageOplogPathTemplate;
    }
