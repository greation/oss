...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add(contextConfig.getProPackage() + ".core.common.annotion.BussinessLog");
        imports.add(contextConfig.getProPackage() + ".core.common.annotion.DataLog");
        imports.add(contextConfig.getProPackage() + ".core.util.ToolUtil");
        imports.add(contextConfig.getProPackage() + ".core.common.annotion.Permission");
        imports.add("java.util.Map");
        imports.add("java.util.HashMap");
        imports.add("com.baomidou.mybatisplus.plugins.Page");
        imports.add(contextConfig.getProPackage() + ".core.common.constant.factory.PageFactory");
        imports.add(contextConfig.getProPackage() + ".core.common.constant.factory.ConstantFactory");
        imports.add(contextConfig.getProPackage() + ".core.shiro.ShiroKit");
        imports.add(contextConfig.getProPackage() + ".modular.system.model.OperationLog");
        imports.add(contextConfig.getProPackage() + ".modular.system.service.IOperationLogService");
        imports.add(contextConfig.getProPackage() + ".modular.system.warpper.OperationLogWrapper");
        imports.add(contextConfig.getProPackage() + ".core.exception.GunsException");
        imports.add(contextConfig.getProPackage() + ".core.exception.GunsExceptionEnum");
        imports.add(contextConfig.getProPackage() + ".core.log.LogObjectHolder");
        imports.add("java.util.Date");
        imports.add("java.util.List");
        imports.add("org.springframework.web.bind.annotation.*");
        imports.add(contextConfig.getProPackage() + ".core.base.warpper.BaseControllerWarpper");
