...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        ...
        globalConfig.setAuthor("ekeyfund");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.ekeyfund.oss.admin.common.persistence.model");
        packageConfig.setMapper("com.ekeyfund.oss.admin.common.persistence.dao");
        packageConfig.setXml("com.ekeyfund.oss.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.ekeyfund.oss.admin");
        contextConfig.setCoreBasePackage("com.ekeyfund.oss.core");
        ...
        contextConfig.setOplogPageSwitch(true);
