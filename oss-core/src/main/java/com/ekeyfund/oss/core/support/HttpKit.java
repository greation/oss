 ...
 */
package com.ekeyfund.oss.core.support;
...
public class HttpKit {
    ...
    /**
     * 获取所有请求的值
     * 如果是form表单请求，直接获取每个元素的值，如果是application/json请求，返回json对象中的每个元素
     *
    ...
    public static Map<String, String> getRequestParameters() {
        ...
        //读取application/x-www-form-urlencoded请求参数
    ...
    /**
     * 从request请求中读取stream以字符串的形式输出
     *
     * 一般用于contentType=application/json的ajax请求处理，获取请求参数以json字符串形式输出
     *
     * 如果是springMVC项目，需要封装HttpServletRequest类，参照BodyReaderHttpServletRequestWrapper
     *
     * @param request HttpServletRequest
     * @return String
     */
    public static String readJSONString(HttpServletRequest request){
        StringBuilder jsongSb = new StringBuilder();
        String line = null;
