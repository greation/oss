...
public class ToolUtil {
    ...
    public static String generatorRandomPassword(){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            int charcater=random.nextInt(characters.length());
            sb.append(num.charAt(number));
            sb.append(characters.charAt(charcater));
    ...
    public static String dateType(Object o) {
        if (o instanceof Date) {
            return DateUtil.getDay((Date) o,"yyyy/MM/dd");
        } else {
            return o.toString();
        }
    }
    ...
    public static String showValue(Object o) {
        if (o instanceof Date) {
            return DateUtil.getTime((Date) o,"yyyy/MM/dd HH:mm:ss");
     ...
     * @Date 2017/4/18 12:55
     */
    public static String timeType(Object o) {
        if (o instanceof Date) {
...
//	}
    ...
    public static String getWebRootPath(String filePath) {
        try {
            ...
            //jar包运行模式，无法获得生成路径，默认放在临时路径下
            if(path == null){
                try {
                    File tmpFile = File.createTempFile("oss_prefix","");
    ...
    public static void main(String[] args) {
        for (int i=0;i<100;i++){
            System.out.println(generatorRandomPassword());
        }
    }
}